    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 overflow-auto ">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="text-center whitespace-nowrap">{{ __('admin.estate') }}</th>
                        ...
                        <th class="text-center whitespace-nowrap">{{ __('validation.attributes.description') }}</th>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a class="flex items-center mr-3"
                                        href="{{ route('dashboard.ad.show', $request->ad->uuid) }}">
                                        <i data-feather="check-square" class="w-4 h-4 mr-1"></i>
                                        {{ __('admin.estate_details') }}
                                    </a>
                                </div>
                            </td>
                        </tr>
...
@section('script')
    <script>
        ...
        $(".deleteBtn").on("click", function() {
            var id = $(this).data('id');
            $('#deleteForm').attr('action', `/dashboard/ad-report/${id}`);
        });
    </script>
@endsection
