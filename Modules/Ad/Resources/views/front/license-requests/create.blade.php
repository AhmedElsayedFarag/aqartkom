            ...
            <div class="row no-gutters">
                <div class="col-md-12">
                    <div class="form-wizard">
                        ...
                        <form action="{{ route('front.license-request.store') }}" id="submitForm" method="post" role="form"
                                ...
                                <div class="aqar-detalis">
                                    ...
                                    <div id="form-upload">
                                        ...
                                        <div class="adding-video">
                                            ...
                                            <video id="video" width="100%" style="margin-top:50px;max-width: 50rem;"
                                                controls></video>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="first">
                                                ...
                                                <input id="validation-form-1" type="text" name="estate[title]"
                                                    ...
                                                    value="{{ isset($model) ? $model->estate->title : old('estate.title') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="first">
                                                ...
                                                <input id="validation-form-1" type="text" name="estate[address]"
                                                    ...
                                                    value="{{ isset($model) ? $model->estate->address : old('estate.address') }}"
                                                    required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6">
                                            <div class="first" id="price">
                                                ...
                                                <input id="validation-form-1" type="number" name="price"
                                                    class="form-control  @error('price') is-invalid @enderror @error('price_of_meters') is-invalid @enderror required-field"
                                                    style="padding-left: 12%;" data-title="السعر" placeholder=""
                                                    min="1"
                                                    value="{{ isset($model) ? $model->price : old('price') }}"
                                                    max="100000000000" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="first">
                                                ...
                                                <select data-title="نوع الاعلان" data-placeholder="اختر" name="type"
                                                    ...
                                                    <option></option>
                                                    <option
                                                        value="sell"{{ isset($model) ? ($model->type->value == 'sell' ? 'selected' : '') : '' }}>
                                                        {{ __('admin.ad_type.sell') }}
                                                    </option>
                                                    <option
                                                        value="rent"{{ isset($model) ? ($model->type->value == 'rent' ? 'selected' : '') : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="first">
                                                ...
                                                <input id="validation-form-1" type="number" name="estate[area]"
                                                    ...
                                                    data-title="المساحة" style="padding-left: 12%;"
                                                    value="{{ isset($model) ? $model->estate->area : old('estate.area') }}"
                                                    max="1000000000" required>
                                                <span class="define">متر٢</span>
                                                <div class="invalid-feedback">
                                                    @error('estate.area')
                                        ...
                                        <div class="col-md-6">
                                            <div class="first">
                                                ...
                                                <textarea id="update-profile-form-5" name="estate[description]" class="form-control required-field length-field"
                                                    data-title="الوصف" placeholder="" data-length-min="3" data-length-max="2000" required>{{ isset($model) ? $model->estate->description : old('estate.description') }}</textarea>
                                                <div class="invalid-feedback">
                                                ...
                                                <select data-placeholder="اختر" name="estate[category]"
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            ...
                                                            data-is-price="{{ $category->is_price_per_meter }}"
                            ...
                            <fieldset class="wizard-fieldset">
                                <div class="aqar-detalis static-details-second">
                                    <h2>موصفات العقار</h2>
                                    <div class="row">
                                        <div class="col-md-6 hidden" id="bedroom-input">
                                            <div class="first">
                                                ...
                                                <input id="validation-form-1" type="number" name="estate[bedroom]"
                                                    ...
                                                    value="{{ isset($model) ? $model->estate->bedroom : old('estate.bedroom') }}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 hidden" id="age-input">
                                            <div class="first">
                                                ...
                                                <input id="validation-form-1" type="number" name="estate[age]"
                                                    ...
                                                    value="{{ isset($model) ? $model->estate->age : old('estate.age') }}">
                                                <div class="invalid-feedback">
                                                    @error('estate.age')
                            ...
                            <fieldset class="wizard-fieldset">
                                <div class="aqar-detalis">
                                    <div class="row">
                                        <div class="col-12">
                                            <input type="hidden" id="lat" name="estate[lat]" value="24.774265" />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group clearfix confim-info">
                                                ...
                                                <a href="javascript:;"
                                                    class="form-wizard-next-btn float-right form-wizard-submit">نشر
                                                    الإعلان</a>
                                            </div>
...
@push('custom-script')
    ...
    <script>
        const validateImagesCount = () => {
            let hasError = false;
            count = imgUpload.files.length + document.querySelector('#video_uploader').files.length;
            if (count < 2 || count > 10) {
        ...
        let label = priceContainer.querySelector('label');
        input = priceContainer.querySelector('input');
