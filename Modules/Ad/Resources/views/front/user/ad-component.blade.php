        ...
        <div class="parent d-flex">
            ...
            <div class="photo">
                ...
                <div class="ad-feat">
                    ...
                    @else
                        @if ($haveToPay)
                            <a href="javascript:;" onclick="showAdFeatureForm('{{ $ad->uuid }}')">
                                <img src="{{ asset('front-end/images/medal.svg') }}">
                                تميز الإعلان
                            </a>
                        @else
                            <a href="javascript:;" onclick="addFeature('{{ $ad->uuid }}')">
                                <img src="{{ asset('front-end/images/medal.svg') }}">
                                تميز الإعلان
                            </a>
                        @endif
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    @if ($ad->is_licensed == 0)
                                        <li><a class="dropdown-item"
                                                href="{{ route('front.user.ad.add-license-number', ['ad' => $ad->uuid]) }}">
                                                اضافة ترخيص الاعلان </a></li>
                                    @endif
                                    @if ($ad->status->value == 'approved')
                                        <li>
                                            <a class="dropdown-item" href="javascript:;"
                                                onclick="copyContent('{{ route('front.aqar.show', ['ad' => $ad->uuid]) }}')">مشاركة
                                                الاعلان</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:;"
                                    ...
                                    @else
                                        <li>
                                            <a class="dropdown-item" href="javascript:;"
                                                onclick="activeAd('{{ $ad->uuid }}')">تنشيط الإعلان</a>
                                        </li>
                                    @endif
                                    {{--
