                        ...
                        <form action="#" method="post" onsubmit="event.preventDefault();submitForm();"
                            ...
                            <div class="first">
                                ...
                                <input type="text"
                                    ...
                                    minlength="3" maxlength="50" name="name" id="name" value="{{ old('name') }}">
                            ...
                            <div class="first">
                                ...
                                <input type="number"
                                    class="form-control required-field @error('phone') is-invalid @enderror" min="0"
                                    data-title="رقم الجوال" name="phone" id="phone" value="{{ old('phone') }}">
                                <div class="invalid-feedback ">
                                    @error('phone')
                                        {{ $errors->first('phone') }}
                                    @enderror
                            ...
                            <div class="first">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('national_number') }}" name="national_number" min="0"
                                    data-title="رقم الهوية الوطنية" id="national_number">
                                <div class="invalid-feedback">
                            ...
                            <div class="first">
                                ...
                                <input type="text" placeholder="الرجاء ادخال سعر المزايدة"
                                    ...
                                    value="{{ old('amount') }}" data-title="سعر المزايدة" min="1" name="amount"
                                    id="amount">
                                <div class="invalid-feedback">
                                    @error('amount')
                                        {{ $errors->first('amount') }}
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="flexCheckDefaults">
                                    <a href="{{route('front.policy',['page'=>'auction-policy'])}}">
