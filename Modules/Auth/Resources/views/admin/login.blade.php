    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            ...
                            <input id="password" type="password"
                                class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="**********">
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button id="btn-login"
                            class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">{{ __('auth.login') }}</button>
                    </div>
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5 justify-end">
                    <img alt="Logo" class="w-1/2" src="{{ asset('default/logo.png') }}">
                    {{-- <span class="text-white text-lg ml-3">
                        Rubick
                    </span> --}}
                </a>
                <div class="my-auto" dir="ltr">
        ...
        (function() {
            async function login() {
                ...
                axios.post(`/dashboard/login`, {
                    ...
                    $('#btn-login').html("{{ __('auth.login') }}")
                    if (err.response.data.message != "{{ __('auth.unauthenticated') }}") {
