...
class MediaServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(MediaManagementInterface::class, function ($app) {
            return config('filesystems.location_storage') == 'local' ? new LocalMediaService() : new RemoteMediaService();
        });
    }
