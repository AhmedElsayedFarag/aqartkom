...
@section('content')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium ml-auto">
            {{ __('admin.update', ['attribute' => __('admin.neighborhood')]) }}
        </h2>
    </div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <form id="admin-form"
                action="{{ route('dashboard.neighborhood.update', ['city' => $city->id, 'neighborhood' => $neighborhood->id]) }}"
                method="POST">
                @method('PUT')
                @csrf
                @include('neighborhood::admin.form')
