        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    <input id="search" type="text" name="search" class="form-control w-56 box pr-10"
                        value="{{ request()->search }}" placeholder="{{ __('admin.search') }}">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="btn btn-warning "
                                        href="{{ route('dashboard.owner.show', $customer->uuid) }}?ad-status=not-licensed"
                                        title="{{ __('admin.show', ['attribute' => __('admin.users.customer')]) }}">
                                        <i data-feather="eye" class="w-4 h-4 mr-1"></i>
                                    </a>
                                    {{-- <a class="flex items-center mr-3"
                                        href="{{ route('dashboard.owner.edit', $customer->uuid) }}"> <i
