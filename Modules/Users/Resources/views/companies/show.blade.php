    ...
    <div class="intro-y box px-5 pt-5 mt-5">
        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
            ...
            <div
                ...
                <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                    <div class="truncate sm:whitespace-normal flex items-center">
                        #{{ $user->license_number }} <i data-feather="info" class="w-4 h-4 mr-2"></i>
                    </div>
                    <div class="truncate sm:whitespace-normal flex items-center">
                    ...
                    <div class="truncate sm:whitespace-normal flex items-center mt-3">
                        {{ $user?->companyProfile?->commercial_register_number }}
        ...
        <ul class="nav nav-link-tabs flex-col sm:flex-row justify-center lg:justify-start text-center pb-3 pt-3"
            ...
            <li class="nav-item" role="presentation">
                <a class="btn btn-primary items-center mr-3" href="{{ route('dashboard.company.edit', $user->uuid) }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <div class="px-5 pb-8 text-center">
                            <form id="sendForm" action="{{ route('dashboard.company.send-topic') }}" method="POST">
                                @csrf
