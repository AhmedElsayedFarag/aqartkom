                                ...
                                <div class="input-form mt-3">
                                    ...
                                    <div class="input-group">
                                        <input id="validation-form-1" type="text" name="whatsapp_number"
                                            ...
                                            value="{{ isset($user) ? \str_replace('+9665', '', $user->marketerProfile->whatsapp_number) : old('whatsapp_number') }}"
                                            required>
                                ...
                                <div class="input-form mt-3">
                                    <label for="validation-form-1" class="form-label w-full flex flex-col sm:flex-row">
                                        {{ __('validation.attributes.advertisement_number') }}
                                        {{-- <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-slate-500">Required, valid phone number</span> --}}
                                    </label>
                                    <div class="input-group">
                                        <input id="validation-form-1" type="number" name="advertisement_number"
                                            class="form-control" placeholder="52345678" aria-describedby="input-group-2"
                                            value="{{ isset($user) ? $user->marketerProfile->advertisement_number : old('advertisement_number') }}"
                                            required>
                                        @error('advertisement_number')
                                            <div class="pristine-error text-danger mt-2">
                                                {{ $errors->first('advertisement_number') }}</div>
                                        @enderror
                                    </div>
