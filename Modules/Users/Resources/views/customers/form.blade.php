                <div class="input-form">
                    ...
                    <input id="validation-form-1" type="file" name="profile_image" class="form-control" accept="image/*">
                    @error('profile_image')
                        <div class="pristine-error text-danger mt-2">{{ $errors->first('profile_image') }}</div>
                    @enderror
