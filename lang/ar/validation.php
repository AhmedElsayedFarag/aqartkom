...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'permissions'            => 'صلاحيات',
        'roles'                 => 'الدور',
        'package_months'        => 'عدد اشهر الاشتراك',
        'advertisement_number' => 'رخصة فال',
        'commercial_register_number' => 'رقم رخصة فال',
        ...
        'estate' => [
            ...
            'area' => 'مساحة العقار',
            'lat' => 'احداثيات العقار',
            'long' => 'احداثيات العقار',
            'bedroom' => 'غرف النوم',
        ], 'estate.neighborhood' => 'الواجهة',
        'estate.age' => 'عمر العقار',
        'estate.city' => 'المدينة',
        'estate.category' => 'الفئة',
        'estate.title' => 'عنوان',
        'estate.address' => 'عنوان العقار',
        'estate.description' => 'تفاصيل العقار',
        'estate.area' => 'مساحة العقار',
        'estate.lat' => 'احداثيات العقار',
        'estate.long' => 'احداثيات العقار',
        'estate.bedroom' => 'غرف النوم',
        'media.*' => 'البوم',
        'details' => 'تفاصيل العقار',
        'price_of_meters' => 'سعر المتر',
        'question' => 'السؤال',
        ...
        'status' => 'الحالة',
        'days' => 'عدد الايام',
        'ad_feature_ads_count' => 'عدد الايام للاعلانات المميزة',
        'coupon' => [
            'code' => 'الكود',
            'name' => 'الإسم',
            'type' => 'النوع',
            'value' => 'القيمة',
            'max_use' => 'أقصي حد للإستخدام',
            'start_at' => 'يبدأ في',
            'expire_at' => 'ينتهي في',
        ...
        'advertiser_relation' => 'علاقة المعلن',
        'nationality_number' => 'رقم الهوية',
        'nationality_id' => 'رقم الهوية',
        'nationality_type' => 'نوع الهوية',
        'subtotal' => 'المجموع الفرعي',
        'subtotal_after_discount' => 'المجموع الفرعي بعد الخصم',
        'vat' => 'الضريبة',
        'discount' => 'الخصم',
        'building_number' => 'رقم المبنى',
        'additional_number' => 'رقم إضافي',
        'postal_number' => 'الرمز البريدي',
        'transaction_id' => 'الرقم التسلسلى ',
        'payment_method' => 'وسيلة الدفع',
        'payment_status' => 'حالة الدفع',
        'account_type' => 'نوع الحساب',
        'total_amount' => 'الاجمالى',
        'order_summery' => 'نفاصيل الطلب',
    ],
